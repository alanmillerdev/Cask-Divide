...
include 'Components/AboutComponents/aboutHeading.inc.php';

include 'Components/AboutComponents/aboutSection1.inc.php';

include 'Components/AboutComponents/aboutSection2.inc.php';

include 'Components/AboutComponents/aboutSection3.inc.php';
